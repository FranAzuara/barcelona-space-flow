...
const InteractiveSelector = () => {
  ...
  const options = [
    {
      title: "Estudio Diáfano Multiusos",
      description: "Amplia sala con suelo de madera y espejos.",
      image:
        "https://res.cloudinary.com/dct5oxj7j/image/upload/v1772097261/Superficie_vc2oed.jpg",
      icon: <FaCampground size={24} className="text-white" />,
    },
    {
      title: "Equipamiento y Almacenaje Funcional",
      description: "Estanterías modernas y zona de control de sonido.",
      image:
        "https://res.cloudinary.com/dct5oxj7j/image/upload/v1772097260/estanteria_rwm9f4.jpg",
      icon: <FaFire size={24} className="text-white" />,
    },
    {
      title: "Ambiente LED Inmersivo",
      description: "Sala con iluminación vibrante.",
      image:
        "https://res.cloudinary.com/dct5oxj7j/image/upload/v1772097261/LED_a4kyog.jpg",
