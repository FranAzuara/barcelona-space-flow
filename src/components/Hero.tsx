      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <AnimateOnScroll>
          <h2 className="text-xl lg:text-2xl font-medium text-white/90 mb-4 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="text-secondary">baile, yoga, pilates</span> y
            eventos.
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <AnimateOnScroll>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <p className="text-white/80">
                Reseñas excelentes de nuestros clientes
              </p>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <p className="text-white/80">
                Acceso directo al transporte público
              </p>
            </div>
          </AnimateOnScroll>
          ...
          <AnimateOnScroll>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <p className="text-white/80">
                Proceso de solicitud ágil y sencillo
              </p>
            </div>
          </AnimateOnScroll>
        </div>
