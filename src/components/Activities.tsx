...
import { Users, Heart, Palette, Star, DollarSign, Wrench, Award, FileText, MapPin, Key } from "lucide-react";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
              <div className="group p-4 rounded-lg bg-background/50 border border-secondary/20 hover:border-secondary/40 hover:shadow-lg transition-all duration-300">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm text-primary font-bold mb-1">CERO COSTES FIJOS</div>
              ...
              <div className="group p-4 rounded-lg bg-background/50 border border-secondary/20 hover:border-secondary/40 hover:shadow-lg transition-all duration-300">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm text-primary font-bold mb-1">VALORACIÓN MÁXIMA (5★)</div>
              ...
              <div className="group p-4 rounded-lg bg-background/50 border border-secondary/20 hover:border-secondary/40 hover:shadow-lg transition-all duration-300">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm text-primary font-bold mb-1">GESTIÓN TRANSPARENTE</div>
              ...
              <div className="group p-4 rounded-lg bg-background/50 border border-secondary/20 hover:border-secondary/40 hover:shadow-lg transition-all duration-300">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm text-primary font-bold mb-1">UBICACIÓN CLAVE</div>
              ...
              <div className="group p-4 rounded-lg bg-background/50 border border-secondary/20 hover:border-secondary/40 hover:shadow-lg transition-all duration-300">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="text-sm text-primary font-bold mb-1">ACCESO INDEPENDIENTE</div>
